...
# Run with:
#   ruby cases/minimal_stable-0.6.rb
#   -or via docker-
#   docker run -it --rm -v "$(pwd)"/cases:/src -w /src ruby:3.2.2 ruby /src/minimal_stable-0.6.rb
...
gemfile do
  ...
  gem "mini_racer", github: "rubyjs/mini_racer", branch: "stable-0.6"
end
